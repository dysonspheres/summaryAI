    ...
    <section className="mt-16 w-full max-w-xl">
      <div className="flex flex-col w-full gap-2">
        ...
        >
          ...
          <input
            type="url"
            placeholder="Enter a URL to your text"
            value={article.url}
      ...
      <div className="my-10 max-w-full flex justify-center items-center">
        {isFetching ? (
          ...
          <p className="font-inter font-bold text-black text-center">
            Looks like something went wrong D:
          ...
          article.summary && (
            <div className="flex flex-col gap-3">
              <h2 className='flex font-satoshi font-bold text-gray-600 text-xl'>
                Article&nbsp; <span className="purple_gradient">Summary</span>
                <div className='ml-2 flex-col copy_btn' onClick={() => handleCopySummary(article.summary)}>
                      <img
